						...
						<div className="lg:col-span-5 flex flex-col gap-4 sm:gap-6 lg:col-start-1 ">
							<div className="flex flex-col gap-2 sm:gap-4">
								<div className="flex items-center gap-3">
									...
									<span
										data-slot="badge"
										className="inline-flex items-center justify-center rounded-md border px-2 py-0.5 text-xs font-medium w-fit whitespace-nowrap shrink-0 gap-1 transition-[color,box-shadow] overflow-hidden
        bg-gradient-to-r from-[var(--color-primary)]/40 to-[var(--color-accent)]/40
        text-[var(--color-primary)]
        border-[var(--color-primary)]/40
        dark:from-[var(--color-primaryActive)]/20 dark:to-[var(--color-accent)]/20 dark:text-[var(--color-primaryActive)] dark:border-[var(--color-primaryActive)]/60"
									>
										<svg
											xmlns="http://www.w3.org/2000/svg"
											width="24"
											...
											className="lucide lucide-star size-2 sm:size-3"
											aria-hidden="true"
											style={{ color: "inherit" }}
										>
											<path d="M11.525 2.295a.53.53 0 0 1 .95 0l2.31 4.679a2.123 2.123 0 0 0 1.595 1.16l5.166.756a.53.53 0 0 1 .294.904l-3.736 3.638a2.123 2.123 0 0 0-.611 1.878l.882 5.14a.53.53 0 0 1-.771.56l-4.618-2.428a2.122 2.122 0 0 0-1.973 0L6.396 21.01a.53.53 0 0 1-.77-.56l.881-5.139a2.122 2.122 0 0 0-.611-1.879L2.16 9.795a.53.53 0 0 1 .294-.906l5.165-.755a2.122 2.122 0 0 0 1.597-1.16z"></path>
        ...
        dark:from-[var(--color-primaryActive)]/20 dark:to-[var(--color-accent)]/20 dark:text-[var(--color-primaryActive)] dark:border-[var(--color-primaryActive)]/60"
					...
					>
						...
						<div className="lg:col-span-5 flex flex-col gap-4 sm:gap-6 lg:col-start-1 ">
							...
							<p className="text-base sm:text-lg text-foreground leading-relaxed">
								A dynamic e-commerce website for footwear,
								featuring product listings, user authentication,
								order processing, and payment integration. Built
								with PHP, MySQL, HTML5, CSS3, and JavaScript,
								the platform offers a seamless shopping
								experience with a responsive design and an
								intuitive admin dashboard for managing products
								and orders.
							</p>
							<div className="flex flex-col gap-2">
								<h4
